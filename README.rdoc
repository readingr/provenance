...
To begin the projects, navigate in terminal to this directory and follow the steps below:
...
3. Open up a separate terminal window, and navigate to the sample-app directory. Under here, run the command "rails server -p 3001. "The access this, go to: http://127.0.0.1:3001/. Create an account and enter the API key
