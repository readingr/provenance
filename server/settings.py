...
LOG_DIR = PROJECT_DIR
UPLOAD_DIR = os.path.join(PROJECT_DIR, 'files/')
...
MIDDLEWARE_CLASSES = (
    ...
    'provserver.django-crossdomainxhr-middleware.XsSharing',
...
AUTH_PROFILE_MODULE = 'provserver.UserProfile'
...
# OAuth settings
OAUTH_AUTHORIZE_VIEW = 'provserver.views.oauth_authorize'
OAUTH_REALM_KEY_NAME = 'https://provenance.ecs.soton.ac.uk'
